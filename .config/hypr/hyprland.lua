...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4.88, bezier = "easeOutQuint", style = "popin 10%" })
...
-- hl.bind("Print", hl.dsp.exec_cmd('grim -g "$(slurp)" "$HOME/Pictures/Screenshots/$(date "+%Y%m%d_%H%M%S").png"'))
hl.bind(
	mainMod .. " + V",
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("~/.config/hypr/scripts/launch.sh && killall dunst && dunst &"))
